...
import pandas as pd
import matplotlib.pyplot as plt  # Corrected import from 'matplot' to 'matplotlib.pyplot'
...
subject = ["Python","c++","java"]  # Corrected list format - removed nested lists
marks = [20,10,5]

fig, ax = plt.subplots()
ax.pie(marks, labels=subject, autopct='%1.1f%%')
st.pyplot(fig)  # Corrected from 'st.ptplot' to 'st.pyplot'
